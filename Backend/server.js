...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: process.env.EMAIL_USER, // Your Gmail email address //fake email
    pass: process.env.EMAIL_PASSWORD, // Use the generated app password here //this password is fake generated dont use for real purposes it wont work
  },
});
